...
<div data-spy="affix" data-offset-top="60" data-offset-bottom="2000" class="pull-right" id="navbar">
	<table class="table table-hover">
			...
			<tr>
				...
				<tr>
				<td class="active"><a href="#hydro"><strong>Гидроустановка</strong> </a></td>
			</tr>
			<tr>
				<td class="active second-menu"><a href="#hydroPower">Электропитание</a></td>
			</tr>
			<tr>
				<td class="active second-menu"><a href="#hydroCircle">Водяное колесо</a></td>
			</tr>
			<tr>
				<td class="active second-menu"><a href="#hydroPump">Насос</a></td>
			</tr>
			<tr>
...
<blockquote>
	<img src="./img/img_new_1.png" alt="" class="improve-img">
	<small>
		1 - корпус-емкость, <br>
2 - водяное колесо, <br>
3 - ось ротора, <br>
...
9 - вентиль.
	...
	<h3 id="hydroPower">Электропитание</h3>
	<h4 id="hydroPowerUnit">Блок питания</h4>
	<img src="./img/img_new_2.png" alt="" class="improve-img">
	<small>
		<br>
		<h4><strong>Х</strong>арактеристики: <br></h4>
		Мощность: 48 Вт <br>
		Напряжение: 5 - 15 В <br>
		Сила тока: 1 - 4 A <br>
		<h4>Блок питания был изготовлен самостоятельно в стенах университета "МЭИ"</h4>
	</small>
	<h4 id="hydroPowerBatery">Аккумулятор</h4>
	<img src="./img/img_1.jpg" height="709" width="399" alt="" class="improve-img">
	<br>
	Герметичный свинцово-кислотный аккумулятор
	<br>Напряжение: 6 В
	<br>Сила тока: 4 A 
	<h3 id="hydroCircle">Водяное колесо</h3>
	<img src="./img/circle.png"  class="improve-img">
	Среднебойное колесо, произведенное кружком "Электротехники"

	<h3 id="hydroPump">Насос</h3>
	<img src="./img/pump.png" class="improve-img">
	<br>
	- Трубки разной высоты <br>
	- Канистра с водой <br>
...
<iframe width="640" height="480"  src="//www.youtube.com/embed/VeKyUsKWEU8" frameborder="0" allowfullscreen class="improve-img"></iframe>
